            ...
            <div class="navbar-right-container" style="display: flex;">
                <div class="navbar-menu-container">
                    ...
                    <span class="navbar-link"></span>
                     <a href="javascript:void(0)" class="navbar-link" v-show="loginName" v-text="`欢迎${loginName}登录`" ></a>
                    <a href="javascript:void(0)" class="navbar-link" @click="showLogin" v-show="!loginName" >Login</a>
                    <a href="javascript:void(0)" class="navbar-link" @click="logoOut">Logout</a>
...
export default {
  ...
  methods: {
    ...
    keepLogin() {
      axios.get("/mock/keepLogin").then(res => {
        if (res.status === 200) {
    ...
    logoOut() {
      axios.get("/mock/logoout").then(res => {
        if (res.status === 200) {
          this.loginName = "";
        }
      });
